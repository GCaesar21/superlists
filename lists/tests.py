...
class NewListTest(TestCase):
	...
	#Test the POST handling functionality
	#Django's test client emulates the browser
	#Send a POST request to the server and get the response object returned by the backend
